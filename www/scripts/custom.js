$(document).ready(function () {      
    ...
    function init_template(){//Class is vital to run AJAX Pages   
        ...
        $('.change-red').click(function(){$('body').removeClass(); $('body').addClass('scheme-red');});
        $('.change-green').click(function(){$('body').removeClass(); $('body').addClass('scheme-green');});
        $('.change-blue').click(function(){$('body').removeClass(); $('body').addClass('scheme-blue');});
        $('.change-mint').click(function(){$('body').removeClass(); $('body').addClass('scheme-mint');});
        $('.change-dark').click(function(){$('body').removeClass(); $('body').addClass('scheme-dark');});
        $('.change-orange').click(function(){$('body').removeClass(); $('body').addClass('scheme-orange');});
        $('.change-magenta').click(function(){$('body').removeClass(); $('body').addClass('scheme-magenta');});

        $('.circle-menu-show, .page-menu-background, .header-icon-1').click(function(){
            $(this).toggleClass('circle-menu-border');
            $('.line-1').toggleClass('active-line-1'); 
            $('.line-2').toggleClass('active-line-2'); 
            $('.line-3').toggleClass('active-line-3'); 
            $('.circle-menu-background').toggleClass('active-circle-menu-background');
            $('.circle-icon').toggleClass('show-circle-icons');
            $('.left-circle-menu').toggleClass('show-left-circle-menu');
            $('.left-circle-menu-1, .left-circle-menu-2, .left-circle-menu-3').toggleClass('left-cricle-menu-active');
            $('.page-menu-background').toggleClass('page-menu-background-active');
            $('.circle-menu, .secondary-menu-show').toggleClass('position-fixed');
            $('.share-bottom').removeClass('active-share-bottom'); 
            return false;
        });
        
        $('.left-circle-menu-1, .header-icon-2').click(function(){
            $('.menu-items').addClass('show-menu-items activate-items');
            $('.menu-items-background').addClass('active-menu-background');
            $('.share-bottom').removeClass('active-share-bottom'); 
        });
                
        $('.left-circle-menu-2').click(function(){
            $('.social-items').addClass('show-menu-items activate-items');
            $('.menu-items-background').addClass('active-menu-background');
            $('.share-bottom').removeClass('active-share-bottom'); 
        });    
        
        $('.left-circle-menu-3').click(function(){
            $('.share-items').addClass('show-menu-items activate-items');
            $('.menu-items-background').addClass('active-menu-background');
            $('.share-bottom').removeClass('active-share-bottom'); 
        });
        ...
        $('.close-menu-items').click(function(){
            $('.menu-items-background').removeClass('active-menu-background'); 
            $('.menu-items, .social-items, .share-items').removeClass('show-menu-items');
            setTimeout(function() {
                 $('.menu-items, .social-items, .share-items').removeClass('activate-items');
            }, 250);
        });
